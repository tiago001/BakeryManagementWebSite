...
namespace BakeryManagement.Controllers
{
    public class CategoriaController : Controller
    {
        ...
        public CategoriaController(Context context, CategoriaDAO categoriaDAO)
        {
            _context = context;
